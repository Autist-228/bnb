...
class SniperBot:
    ...
    def _record_market_data(self, token, liq_usd, liq_bnb, safety, ml_score, result):
        ...
        row = [
            ...
            safety.is_ownership_renounced if safety else "",
            safety.has_proxy if safety else "",
            safety.is_mintable if safety else "",
            safety.holder_count_estimate if safety else "",
            safety.top_holder_percent if safety else "",
            safety.score if safety else "",
            ml_score,
            price_impact,
            token_age,
            token.total_supply,
